  ...
  class SalariesAndTaxes < Exporter::Resource
    ...
    def convert(salary)
      ...
      salary_and_taxes = [
        {
          ...
          :date                       => @options[:date],
          :title                      => salary.title,
          :description                => desc_for(salary) + "/" + I18n.t("salaries.salary.views.gross"),
      ...
      salary_and_taxes << {
          ...
          :date                       => @options[:date],
          :title                      => salary.title,
          :description                => desc_for(salary) + "/" + I18n.t("salaries.salary.views.net"),
      ...
      if employer_taxes_resource
        ...
        salary_and_taxes << {
            ...
            :date                       => @options[:date],
            :title                      => salary.title,
            :description                => desc_for(salary) + "/" + I18n.t("salaries.salary.views.employer_part"),
